    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      <Card className="shadow-lg">
        <CardHeader className="border-b">
          <CardTitle className="text-3xl font-bold">Create Your Event</CardTitle>
          <CardDescription className="text-lg">
            Fill in the details below to set up your event chat assistant
          </CardDescription>
        </CardHeader>
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      This number will be displayed on the event chat page
                    </p>
                  </div>
                </div>
              </div>
            ...
            {error && (
              <div className="p-4 text-sm border border-red-300 bg-red-50 text-red-600 rounded-md">
                {error}
              </div>
            )}
